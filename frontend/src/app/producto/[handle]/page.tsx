...
const PRODUCT_FIELDS =
  "id,title,handle,description,thumbnail,images.*,options.*,options.values.*,variants.*,variants.thumbnail,variants.prices.*,variants.calculated_price.*,variants.options.*,variants.metadata,variants.images.*,variants.inventory_quantity,variants.allow_backorder,variants.manage_inventory,categories.*,collection_id,collection.*,material,weight,height,width,length,metadata,tags.*,mt_brand.*,mt_vendor.*,mt_product_extension.*"
